...
### Heat Map of COVID-19 Confirmed Cases
...
```{r }
# recent cumulatived case and join daily case summary with code name
...
```{r map_3d}
confirm_map_3d <- plotly::plot_geo() %>%
  layout(geo = geo) %>%
...
##### Situation Across Region

```{r kable_case}
kable(recent_case_cum[,1:5])
```